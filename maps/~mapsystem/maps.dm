...
/datum/map
	...
	var/list/available_cultural_info = list(
		...
		TAG_FACTION =   list(/decl/cultural_info/faction/other, /decl/cultural_info/faction/united_nations, /decl/cultural_info/faction/wehs, /decl/cultural_info/faction/wma, /decl/cultural_info/faction/saf, /decl/cultural_info/faction/adc, /decl/cultural_info/faction/novagene, /decl/cultural_info/faction/scp),
