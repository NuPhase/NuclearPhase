...
/obj/item/clothing/suit/poncho/roles/science/nanotrasen
	name = "\improper Fictional Company poncho"
	desc = "A simple, comfortable cloak without sleeves. This one is white with a few red stripes, colors of Fictional Company. Go Fictional Company!"
