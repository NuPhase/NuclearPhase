...
/obj/item/projectile/beam/plasma_discharge/on_impact(atom/A)
	. = ..()
	cell_explosion(get_turf(A), 1000, 500, EXPLOSION_FALLOFF_SHAPE_EXPONENTIAL, z_transfer = null, temperature = 50000)
