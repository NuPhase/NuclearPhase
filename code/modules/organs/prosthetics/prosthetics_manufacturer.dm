/decl/prosthetics_manufacturer
	...
	var/icon = 'icons/mob/species/cyberlimbs/robotic.dmi'     // Icon base to draw from.
...
/decl/prosthetics_manufacturer/proc/get_base_icon(var/mob/living/carbon/human/owner, masked)
	return icon