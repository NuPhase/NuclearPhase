...
/obj/machinery/reactor_display/group/steamloop/get_display_data()
	. = ..()
	var/data = ""
	data = "HEATEXCHANGER-M IN|Pressure:[rcontrol.get_meter_pressure("HEATEXCHANGER V-IN")]kPa|Temperature:[rcontrol.get_meter_temperature("HEATEXCHANGER V-IN")]K|Mass:[rcontrol.get_meter_mass("HEATEXCHANGER V-IN")]KG.<br>\
