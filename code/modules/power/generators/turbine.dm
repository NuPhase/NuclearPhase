...
/obj/machinery/compressor/Process()
	...
	if(rpm>50000)
		overlays += image('icons/obj/atmospherics/pipes/pipes-s.dmi', "comp-o4", FLY_LAYER)
	else if(rpm>10000)
		overlays += image('icons/obj/atmospherics/pipes/pipes-s.dmi', "comp-o3", FLY_LAYER)
	else if(rpm>2000)
		overlays += image('icons/obj/atmospherics/pipes/pipes-s.dmi', "comp-o2", FLY_LAYER)
	else if(rpm>500)
		overlays += image('icons/obj/atmospherics/pipes/pipes-s.dmi', "comp-o1", FLY_LAYER)
	 //TODO: DEFERRED
...
/obj/machinery/turbine/Process()
	...
	if(lastgen > 100)
		overlays += image('icons/obj/atmospherics/pipes/pipes-s.dmi', "turb-o", FLY_LAYER)
