...
/obj/machinery/power/generator/port_gen
	...
	var/sound_id
	var/working_sound
	var/output_voltage = 220

/obj/machinery/power/generator/port_gen/proc/IsBroken()
	return (stat & (BROKEN|EMPED))

/obj/machinery/power/generator/port_gen/proc/HasFuel() //Placeholder for fuel check.
	return 1

/obj/machinery/power/generator/port_gen/proc/UseFuel(power_requirement) //Placeholder for fuel use.
	return

/obj/machinery/power/generator/port_gen/proc/DropFuel()
	return

/obj/machinery/power/generator/port_gen/proc/handleInactive()
	return

/obj/machinery/power/generator/port_gen/proc/update_sound()
	if(!working_sound)
		return
	if(!sound_id)
...
/obj/machinery/power/generator/port_gen/get_voltage()
	return output_voltage

/obj/machinery/power/generator/port_gen/available_power()
	if(active && HasFuel() && !IsBroken() && anchored)
		return power_gen
	else
		return 0

/obj/machinery/power/generator/port_gen/on_power_drain(w)
	UseFuel(w)

/obj/machinery/power/generator/port_gen/Process()
	..()
	if(active && HasFuel() && !IsBroken() && anchored)
		UseFuel(5)
		src.updateDialog()
...
/obj/machinery/power/generator/port_gen/on_update_icon()
	if(!active)
...
/obj/machinery/power/generator/port_gen/CanUseTopic(mob/user)
	if(!anchored)
		to_chat(user, "<span class='warning'>The generator needs to be secured first.</span>")
		return STATUS_CLOSE
	return ..()

/obj/machinery/power/generator/port_gen/examine(mob/user, distance)
	. = ..()
	if(distance > 1)
		return
	if(active)
...
/obj/machinery/power/generator/port_gen/emp_act(severity)
	if(!active)
		return
...
/obj/machinery/power/generator/port_gen/proc/explode()
...
/obj/machinery/power/generator/port_gen/pacman/examine(mob/user)
	. = ..()
	if(active)
...
/obj/machinery/power/generator/port_gen/pacman/Initialize()
	. = ..()
...
/obj/machinery/power/generator/port_gen/pacman/Destroy()
	DropFuel()
	return ..()

/obj/machinery/power/generator/port_gen/pacman/RefreshParts()
...
/obj/machinery/power/generator/port_gen/pacman/proc/process_exhaust()
	var/decl/material/mat = GET_DECL(sheet_material)
...
/obj/machinery/power/generator/port_gen/pacman/HasFuel()
...
/obj/machinery/power/generator/port_gen/pacman/DropFuel()
	if(sheets)
...
/obj/machinery/power/generator/port_gen/pacman/UseFuel()
...
/obj/machinery/power/generator/port_gen/pacman/handleInactive()
...
/obj/machinery/power/generator/port_gen/pacman/proc/overheat()
	overheating++
	if (overheating > max_overheat)
		explode()

/obj/machinery/power/generator/port_gen/pacman/explode()
...
/obj/machinery/power/generator/port_gen/pacman/emag_act(var/remaining_charges, var/mob/user)
	if (active && prob(25))
...
/obj/machinery/power/generator/port_gen/pacman/components_are_accessible(path)
	return !active && ..()

/obj/machinery/power/generator/port_gen/pacman/cannot_transition_to(state_path, mob/user)
	if(active)
		return SPAN_WARNING("You cannot do this while \the [src] is running!")
	return ..()

/obj/machinery/power/generator/port_gen/pacman/attackby(var/obj/item/O, var/mob/user)
...
/obj/machinery/power/generator/port_gen/pacman/dismantle()
	while (sheets > 0)
		DropFuel()
	. = ..()

/obj/machinery/power/generator/port_gen/pacman/interface_interact(mob/user)
	ui_interact(user)
	return TRUE

/obj/machinery/power/generator/port_gen/pacman/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	if(IsBroken())
		return
...
/obj/machinery/power/generator/port_gen/pacman/Topic(href, href_list)
	if(..())
		return
...
/obj/machinery/power/generator/port_gen/pacman/super
...
/obj/machinery/power/generator/port_gen/pacman/super/process_exhaust()
	return

/obj/machinery/power/generator/port_gen/pacman/super/UseFuel()
	//produces a tiny amount of radiation when in use
	if (prob(rad_power*power_output))
		SSradiation.radiate(src, 2*rad_power)
	..()

/obj/machinery/power/generator/port_gen/pacman/super/on_update_icon()
	if(..())
		set_light(0)
		return 1
	overlays.Cut()
...
/obj/machinery/power/generator/port_gen/pacman/super/explode()
...
/obj/machinery/power/generator/port_gen/pacman/super/potato
...
/obj/machinery/power/generator/port_gen/pacman/super/potato/Initialize()
	create_reagents(120)
	. = ..()

/obj/machinery/power/generator/port_gen/pacman/super/potato/examine(mob/user)
	. = ..()
	to_chat(user, "Auxilary tank shows [reagents.total_volume]u of liquid in it.")

/obj/machinery/power/generator/port_gen/pacman/super/potato/UseFuel()
...
/obj/machinery/power/generator/port_gen/pacman/super/potato/on_update_icon()
	if(..())
		return 1
	if(power_output > max_safe_output)
		icon_state = "potatodanger"

/obj/machinery/power/generator/port_gen/pacman/super/potato/attackby(var/obj/item/O, var/mob/user)
...
/obj/machinery/power/generator/port_gen/pacman/mrs
...
/obj/machinery/power/generator/port_gen/pacman/mrs/explode()
