...
/datum/configuration
	var/server_name = "Nuclear Phase"		// server name (for world name / status)
...
//	var/enable_authentication = 0		// goon authentication
	...
	var/walk_delay = 4
	var/creep_delay = 6
	var/minimum_sprint_cost = 3
	var/skill_sprint_cost_range = 10
	...
	var/max_gear_cost = 100 // Used in chargen for accessory loadout limit. 0 disables loadout, negative allows infinite points.
