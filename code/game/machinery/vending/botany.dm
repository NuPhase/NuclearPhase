...
/obj/machinery/vending/hydroseeds
	...
	products = list(
		...
		/obj/item/seeds/chantermycelium = 0,
		/obj/item/seeds/chiliseed = 2,
		/obj/item/seeds/cornseed = 4,
		/obj/item/seeds/eggplantseed = 2,
		/obj/item/seeds/potatoseed = 7,
		/obj/item/seeds/soyaseed = 5,
		/obj/item/seeds/sunflowerseed = 4,
		/obj/item/seeds/tomatoseed = 3,
		/obj/item/seeds/towercap = 1,
		/obj/item/seeds/wheatseed = 3,
		/obj/item/seeds/appleseed = 3,
		/obj/item/seeds/poppyseed = 6,
		/obj/item/seeds/sugarcaneseed = 3,
		/obj/item/seeds/ambrosiavulgarisseed = 0,
		...
		/obj/item/seeds/grassseed = 13,
		/obj/item/seeds/cocoapodseed = 1,
		/obj/item/seeds/plumpmycelium = 0,
		/obj/item/seeds/cabbageseed = 3,
		/obj/item/seeds/grapeseed = 3,
		/obj/item/seeds/pumpkinseed = 3,
		/obj/item/seeds/cherryseed = 3,
		/obj/item/seeds/plastiseed = 3,
		/obj/item/seeds/riceseed = 7,
