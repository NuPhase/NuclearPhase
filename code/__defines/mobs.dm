...
#define PULSE_SLOW    30   // <60     bpm
#define PULSE_NORM    60   //  60-90  bpm
#define PULSE_FAST    90   //  90-120 bpm
#define PULSE_2FAST   120   // >120    bpm
#define PULSE_THREADY 170   // Occurs during hypovolemic shock
