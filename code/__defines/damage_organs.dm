...
#define FLUIDLOSS_WIDE_BURN 0.06 //for burns from heat applied over a wider area, like from fire
#define FLUIDLOSS_CONC_BURN 0.04 //for concentrated burns, like from lasers
