...
#define ACCESSORY_SLOT_MODULES  "Modules"
...
// Pressure limits.
#define  HAZARD_HIGH_PRESSURE 3660 // This determines at what pressure the ultra-high pressure red icon is displayed. (This one is set as a constant)
#define WARNING_HIGH_PRESSURE 365 // This determines when the orange pressure icon is displayed (it is 0.7 * HAZARD_HIGH_PRESSURE)
...
#define BODYTEMP_COLD_DIVISOR           18   // Similar to the BODYTEMP_AUTORECOVERY_DIVISOR, but this is the divisor which is applied at the stage that follows autorecovery. This is the divisor which comes into play when the human's loc temperature is lower than their body temperature. Make it lower to lose bodytemp faster.
#define BODYTEMP_HEAT_DIVISOR           18   // Similar to the BODYTEMP_AUTORECOVERY_DIVISOR, but this is the divisor which is applied at the stage that follows autorecovery. This is the divisor which comes into play when the human's loc temperature is higher than their body temperature. Make it lower to gain bodytemp faster.
#define BODYTEMP_COOLING_MAX           -2 // The maximum number of degrees that your body can cool down in 1 tick, when in a cold area.
#define BODYTEMP_HEATING_MAX            2 // The maximum number of degrees that your body can heat up in 1 tick,   when in a hot  area.
...
#define       HELMET_MIN_COLD_PROTECTION_TEMPERATURE 220 // For normal helmets.
#define        ARMOR_MIN_COLD_PROTECTION_TEMPERATURE 220 // For armor.
#define       GLOVES_MIN_COLD_PROTECTION_TEMPERATURE 160 // For some gloves.
#define         SHOE_MIN_COLD_PROTECTION_TEMPERATURE 160 // For shoes.

#define  UNIVERSAL_PRESSURE_SUIT_MIN_COLD_PROTECTION_TEMPERATURE   25
#define  	  COLD_PRESSURE_SUIT_MIN_COLD_PROTECTION_TEMPERATURE   8
#define  	   HOT_PRESSURE_SUIT_MIN_COLD_PROTECTION_TEMPERATURE   200
#define  ENGINEERING_PRESSURE_SUIT_MIN_COLD_PROTECTION_TEMPERATURE 60 //should be adequate

#define  			  SPACE_SUIT_MAX_HEAT_PROTECTION_TEMPERATURE 700  // These need better heat protect, but not as good heat protect as firesuits.
#define    			    FIRESUIT_MAX_HEAT_PROTECTION_TEMPERATURE 1920 // What max_heat_protection_temperature is set to for firesuit quality headwear. MUST NOT BE 0.
#define 			 FIRE_HELMET_MAX_HEAT_PROTECTION_TEMPERATURE 1920 // For fire-helmet quality items. (Red and white hardhats)
#define      			  HELMET_MAX_HEAT_PROTECTION_TEMPERATURE 600   // For normal helmets.
#define       			   ARMOR_MAX_HEAT_PROTECTION_TEMPERATURE 600   // For armor.
#define      			  GLOVES_MAX_HEAT_PROTECTION_TEMPERATURE 1100  // For some gloves.
#define        		        SHOE_MAX_HEAT_PROTECTION_TEMPERATURE 1100  // For shoes.

#define  UNIVERSAL_PRESSURE_SUIT_MAX_HEAT_PROTECTION_TEMPERATURE   820 //just barely
#define  	  COLD_PRESSURE_SUIT_MAX_HEAT_PROTECTION_TEMPERATURE   410
#define  	   HOT_PRESSURE_SUIT_MAX_HEAT_PROTECTION_TEMPERATURE   1400
#define  ENGINEERING_PRESSURE_SUIT_MAX_HEAT_PROTECTION_TEMPERATURE 4400 //THC melting point + some overhead for active cooling


#define  FIRESUIT_MAX_PRESSURE 		2 * ONE_ATMOSPHERE   // Firesuis and atmos voidsuits
#define  RIG_MAX_PRESSURE 			15 * ONE_ATMOSPHERE   // Rigs
#define  LIGHT_RIG_MAX_PRESSURE 	7.5 * ONE_ATMOSPHERE   // Rigs
#define  ENG_VOIDSUIT_MAX_PRESSURE 	5 * ONE_ATMOSPHERE
#define  VOIDSUIT_MAX_PRESSURE 		3 * ONE_ATMOSPHERE
#define  SPACE_SUIT_MAX_PRESSURE 	1.5 * ONE_ATMOSPHERE
#define  PRESSURE_SUIT_MAX_PRESSURE	20 * ONE_ATMOSPHERE
#define  ENGIE_SUIT_MAX_PRESSURE	90 * ONE_ATMOSPHERE
